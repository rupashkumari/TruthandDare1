...
class WouldYouRather extends StatefulWidget {
  const WouldYouRather({Key? key}) : super(key:key);

  @override
  State<WouldYouRather> createState() => _WouldYouRatherState();
}

class _WouldYouRatherState extends State<WouldYouRather> {
  String question = '';
  bool isLoading = true;
  ...
  Future<void> fetchQuestion() async {
    final url = Uri.parse('https://api.truthordarebot.xyz/api/wyr'); // Replace with your API URL
