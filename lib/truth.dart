...
class _TruthState extends State<Truth> {
  String question = ''; // Holds the fetched question
  bool isLoading = true; // Show a loading spinner while fetching data

  @override
  void initState() {
    super.initState();
    fetchQuestion(); // Call API when widget is initialized
  }



  Future<void> fetchQuestion() async  {
    final url = Uri.parse('https://api.truthordarebot.xyz/v1/truth'); // Replace with your API URL
